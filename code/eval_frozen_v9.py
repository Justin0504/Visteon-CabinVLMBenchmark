...
MODELS={"v7":R+"/models/bootstrap_v7_merged","v9":R+"/models/bootstrap_v9_merged"}
...
json.dump(res,open(R+"/data/eval_frozen_v9.json","w"),indent=1); print("EVAL_FROZEN",json.dumps(res)); print("EVAL_FROZEN_DONE")
