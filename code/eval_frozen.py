...
MODELS={"base":R+"/models/Qwen2.5-VL-7B-Instruct","v1":R+"/models/bootstrap_v1_merged","v2":R+"/models/bootstrap_v2_merged","v3":R+"/models/bootstrap_v3_merged"}
...
json.dump(res,open(R+"/data/eval_frozen.json","w"),indent=1); print("EVAL_FROZEN",json.dumps(res)); print("EVAL_FROZEN_DONE")
