...
def ok(img,gt,a):
    r=gen(jm,jp,img,f'Ground-truth: "{gt}". Candidate answer: "{a}". Do they mean the same? Reply ONLY yes or no.',8).lower()
...
json.dump(res,open(R+"/data/eval_frozen_v12.json","w"),indent=1); print("EVAL_FROZEN",json.dumps(res)); print("EVAL_FROZEN_DONE")
