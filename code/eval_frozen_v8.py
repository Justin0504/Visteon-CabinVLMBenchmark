...
MODELS={"v7":R+"/models/bootstrap_v7_merged","v8":R+"/models/bootstrap_v8_merged"}
...
json.dump(res,open(R+"/data/eval_frozen_v8.json","w"),indent=1); print("EVAL_FROZEN",json.dumps(res)); print("EVAL_FROZEN_DONE")
