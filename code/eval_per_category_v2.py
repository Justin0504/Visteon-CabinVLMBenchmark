...
held=json.load(open(R+"/data/heldout_v2.json"))
...
MODELS={"base":R+"/models/Qwen2.5-VL-7B-Instruct","v1":R+"/models/bootstrap_v1_merged","v2":R+"/models/bootstrap_v2_merged"}
...
json.dump(res,open(R+"/data/eval_v2.json","w"),indent=1); print("EVAL_V2",json.dumps(res)); print("EVAL_V2_DONE")
