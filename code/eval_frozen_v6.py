...
MODELS={"base":R+"/models/Qwen2.5-VL-7B-Instruct","v3":R+"/models/bootstrap_v3_merged","v6":R+"/models/bootstrap_v6_merged"}
...
json.dump(res,open(R+"/data/eval_frozen_v6.json","w"),indent=1); print("EVAL_FROZEN",json.dumps(res)); print("EVAL_FROZEN_DONE")
